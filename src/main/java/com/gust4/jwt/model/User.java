...
public class User implements UserDetails, Serializable {
    ...
    /*
    lista responsavel por criar a tabela que mapeia as permissoes do usuario
    usando a classe atual e a classe permission, criando uma nova tabela com o ID de ambas as classes
    */

    public User() {}

    //Método feito para pegar as permissões do usuario
